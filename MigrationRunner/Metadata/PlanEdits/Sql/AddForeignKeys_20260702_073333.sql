...
BEGIN
    ALTER TABLE [ContactsTbl] WITH NOCHECK ADD CONSTRAINT [FK_ContactsTbl_PreferedAgentID] FOREIGN KEY([PreferedAgentID]) REFERENCES [PeopleTbl]([PersonID]);
END
GO
...
BEGIN
    ALTER TABLE [TempCoffeecheckupCustomerTbl] WITH NOCHECK ADD CONSTRAINT [FK_TempCoffeecheckupCustomerTbl_PreferedAgentID] FOREIGN KEY([PreferedAgentID]) REFERENCES [PeopleTbl]([PersonID]);
END
GO
